...
class DetalhesFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.activity_main_detalhes3, container, false)

        voltarhome = view.findViewById(R.id.imageView7)
        ...
        ViewCompat.setOnApplyWindowInsetsListener(view.findViewById(R.id.imageView7)) { v, insets ->
