...
class DetalhesFragment4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.activity_main_detalhes4, container, false)

        voltarhome = view.findViewById(R.id.imageView12)
        ...
        ViewCompat.setOnApplyWindowInsetsListener(view.findViewById(R.id.imageView12)) { v, insets ->
