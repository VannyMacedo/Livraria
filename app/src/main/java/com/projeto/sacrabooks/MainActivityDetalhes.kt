...
class DetalhesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.activity_main_detalhes, container, false)

        voltarhome = view.findViewById(R.id.imageView4)
        ...
        ViewCompat.setOnApplyWindowInsetsListener(view.findViewById(R.id.imagemlogin)) { v, insets ->
